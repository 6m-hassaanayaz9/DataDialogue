    ...
    def post(self, request):
        ...
        try:
            ...
            if password != user.password:
                print("Invalid my if  password")
                return JsonResponse({"status": 400, "message": "Invalid credentials"}, status=400)
            print("User my if  found")
            return JsonResponse({"status": 200, "message": "Valid credentials"}, status=200)
        ...
        #     print("UserRRRRRRRRRRR not found")
        #     return JsonResponse({"status": 400, "message": "User not found"}, status=400)
        ...
        # if not check_password(password, user.password):
        #     print("UserIIIIIIIIIIIIIIIII not found")
        #     return JsonResponse({"status": 400, "message": "Invalid credentials"}, status=400)
